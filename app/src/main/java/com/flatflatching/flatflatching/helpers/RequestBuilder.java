...
public class RequestBuilder {
    ...
    public JSONObject getCreateFlatRequest(final String accountToken, final String flatName) throws JSONException {
        final JSONObject requestParams = new JSONObject();
    ...
    public JSONObject getCreateFlatRequestWithAddress(final String accountToken, final String flatName,
